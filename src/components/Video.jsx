    ...
    <Stack direction={['column','row']} h={'100vh'}>
        <VStack w={'full'}>
            ...
            <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
                ...
                <Text>This is a sample video. Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe ad ipsam dolores error ut earum, provident culpa quas labore ea, excepturi, ullam mollitia officiis laborum incidunt velit magni! Minima, autem!Lorem Lorem ipsum dolor, sit amet consectetur adipisicing elit. Atque accusantium nesciunt, nostrum consequuntur rem odit totam magni corrupti deserunt debitis molestiae et sit placeat voluptatem, porro ratione recusandae vero nam?</Text>
            </VStack>
        </VStack>
        <VStack p={'8'} overflowY={'auto'} spacing={'8'} w={['full','xl']} alignItems={'stretch'}>
            {videosArr.map((item,indx)=>
            (
                <Button variant={'ghost'} colorScheme={'purple'} onClick={()=>setVideosrc(item)}>Lecture no {indx+1}</Button>
